...
class EXP():
    ...
    async def profile(self, ctx, *, user: str):
        ...
        if data[0][0] < 1:
            ...
            embed.add_field(name = "User ID", value=selfdata[0][1], inline=True)
            embed.add_field(name = "User Name", value=selfdata[0][2], inline=True)
            embed.add_field(name="Level", value=selfdata[0][3], inline=False)
            ...
            embed.add_field(name="Level", value=data[0][3], inline=False)
